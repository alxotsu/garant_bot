...
class ru:
    ...
    referral_info = (
        ...
        "🧾 Ваш ChatID <b><code>{chat_id}</code></b>.\n"
        "🧾 Чтобы пригласить пользователя, он должен ввести ваш ChatID в этом разделе.\n"
        "🧾 Ваше приглашение подтвердили {referrals_count} пользователей."
    )
    referral_input_chat_id_button = "Ввести ChatID"
    referral_input_chat_id = (
        "Введите ChatID пользователя, который вас пригласил. "
        "Для отмены напишите \"-\" без кавычек."
    )
    referral_yourself_error = "⛔️ Вы не можете пригласить сами себя."
    referral_success = "Реферальная программа подключена."
    new_referral = (
        "Новый пользователь ввёл ваш ChatID в качестве приглашения\n"
        "Ваше приглашение подтвердили {referrals_count} пользователей."
    )
    referral_withdrawal = (
