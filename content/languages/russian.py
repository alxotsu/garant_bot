...
class ru:
    ...
    enable_keyboard = "Клавиатура включена."
    have_deal_now = (
    ...
    it_is_not_address = "⛔️ Это не адрес кошелька в TRON."
    unique_address_error = "⛔️Кошелёк с таким адресом уже зарегистрирован."

    # input balance
    input_balance_button = "Пополнение баланса"
    wallet_input = (
        "⚠️ Пополнение баланса\n"
        "Чтобы пополнить баланс, отправьте желаемую сумму на кошелёк сервиса в TRC20.\n"
    ...
    referral_info = (
        ...
        "пригласивший пользователь получает бонус в размере {bonus}% от комиссии на свой баланс.\n\n"
    ...
    cannot_invite_referral = "⛔️ Вы не можете пригласить этого пользователя."
